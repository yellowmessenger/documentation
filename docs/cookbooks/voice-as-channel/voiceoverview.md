...
1. [Basics of conversational voice AI vs conversational AI](#intro) 
2. [Application and fundamentals of conversational voice AI](#fundamentals)
3. [Voice bots in yellow.ai ecosystem](#ecosystem) 
...
**Exploring Conversational Voice AI for Enhanced User Interaction**
...
### 1.1 Adapting to customer needs with voice bots
