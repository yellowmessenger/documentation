---
title : Powerful analytics and reports (access CDR and dashboard on insights page)
...
- The CDR table contains several fields that record various details about the call, such as **call duration, caller ID, called number, call status, and call type**. 
...
2. Open **Call details report**. 
3. You can **download** this report as CSV by clicking the **Actions** button.  
    ![](https://i.imgur.com/qp6CsVq.png)

> For more details on **Data explorer/ Default tables**/ **Summarization**/ **Vizualisation**, click [here](https://docs.yellow.ai/docs/platform_concepts/growth/data-explorer). 

----

## 2. CDR fields and their definitions
