...
* Enable single sign-on (SSO) with your enterprise identity provider such as Azure AD, Okta, or JumpCloud and align with your organization's security policies.
...
| -------------------------------- | ------------------------------------ | ------------------------------------------------------------- |
| Authentication fails immediately | Redirect URI mismatch                | Ensure Redirect URI matches in both IdP and AI agent configuration |
...
| AI agent not redirecting              | Missing Check User Session node      | Ensure the flow includes session validation                   |
