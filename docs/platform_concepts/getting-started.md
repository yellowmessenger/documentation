...
Here’s what supports you in Assist:
   ...
   * **Agent Assist** – AI suggests the best responses while your agents chat with users. [Learn more](https://docs.yellow.ai/docs/platform_concepts/inbox/inbox_setup/agentassistbot)
   * **Human Helpdesk Escalation** – Pass chats to agents with full context, without starting over. [Learn more](https://docs.yellow.ai/docs/platform_concepts/inbox)
   * **User 360** – See everything you need to know about your customer in one place. [Learn more](https://docs.yellow.ai/docs/platform_concepts/engagement/cdp/overview)
...
* **Quantitative Analytics** – Track numbers like resolution time, CSAT, automation rates, and more. [Learn more](https://docs.yellow.ai/docs/platform_concepts/growth/dataexplorer/intro)
...
* **Self-Learning KB/Flows** – Your AI gets smarter over time by learning from missed queries. [Learn more](https://docs.yellow.ai/docs/platform_concepts/analyze/articlesuggestion)
* **Custom Dashboards** – Build dashboards to focus on what matters most to your team. [Learn more](https://docs.yellow.ai/docs/platform_concepts/growth/Dashboards/custom_dashboards)
...
Create AI agents that do the heavy lifting—so your teams can focus on what matters.

* Design and launch AI agents without writing code, using intuitive, prompt-based workflows.
* Automate up to 90% of customer interactions with AI agents that understand and adapt to evolving intents.
* Proactively resolve queries with intelligent triggers based on user behavior and message patterns.
* Accelerate operations across channels, from support to service requests, with 24/7 AI responsiveness.

[**Explore Automation documentation ➝**](https://docs.yellow.ai/docs/platform_concepts/studio/overview)


#### Assist with Human + AI Synergy
Support your teams with the right tools at the right moment.

* Deliver real-time, context-aware support to agents, improving speed and accuracy.
* Use AI tools like tone adjustment, sentiment detection, and agent coaching to elevate customer conversations.
* Seamlessly escalate from bot to human—ensuring customers always reach the right resource.
* Centralize support with live agent tools across chat, email, and more—powered by deep CRM integrations or standalone AI helpdesk.

[**Explore Assist documentation ➝**](https://docs.yellow.ai/docs/platform_concepts/inbox/inbox_setup/agentassistbot)


#### Analyze for Continuous Improvement
Turn every interaction into insight—and every insight into impact.

* Track 20+ real-time metrics with dashboards, user journeys, and outcome-based analysis.
* Surface gaps and trends across conversations to fine-tune automation and agent effectiveness.
* Explore both quantitative and qualitative insights to inform strategy and improve ROI.
* Customize dashboards and access data explorers for advanced business intelligence.

[**Explore Analyze documentation ➝**](https://docs.yellow.ai/docs/platform_concepts/analyze/analyseintro)



#### Unify Channels & Campaigns
Meet your customers where they are—every time.

* Launch omnichannel campaigns across messaging, email, and voice from one platform.
* Connect to 35+ communication channels with one-time setup and consistent AI-agent behavior.
* Personalize engagement at scale with AI-powered customer segmentation and targeting.

[**Explore Engage documentation ➝**](https://docs.yellow.ai/docs/platform_concepts/engagement/engage)

[**Explore Channels documentation ➝**](https://docs.yellow.ai/docs/platform_concepts/channelConfiguration/overview)



#### Scale with Confidence
Built for enterprise-grade performance, security, and extensibility.

* Deploy with confidence—on Cloud or On-Premise—with flexible architecture options.
* Plug into 150+ pre-built integrations or extend via APIs and SDKs to fit your ecosystem.
* Achieve secure, compliant AI operations with ISO, HIPAA, SOC2, and GDPR certifications.

[**Explore Integrations documentation ➝**](https://docs.yellow.ai/docs/platform_concepts/appConfiguration/overview)

#### Speak Every Language, Support Every User
Go global with multilingual AI agents that localize and personalize.

* Communicate naturally with customers in 135+ languages.
* Maintain brand consistency while adapting tone and vocabulary for each region.

[**See supported languages ➝**](https://docs.yellow.ai/docs/platform_concepts/studio/build/localization)

#### Get Expert Support, Every Step of the Way
From setup to scale, we’ve got you covered.

* Gain access to dedicated support for upgraded AI agents.
* Work with a team that brings deep domain knowledge and best practices.
* Reduce risk, lower costs, and launch faster with professional services and expert guidance.
...
Need quick answers or guidance? Chat with Mia, our built-in AI assistant trained to support your journey.


- On our **[Cloud platform](https://cloud.yellow.ai)**: Click **Help** > **Ask a question** to engage with Mia. 
- On our [**Documentation site**](https://docs.yellow.ai page): Find Mia at the bottom of each page and initiate a chat.
<!--
