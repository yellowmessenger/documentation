...
| Organise your conversational logic                                                                                                                              | Each node is a point of flow. Use [Nodes](https://docs.yellow.ai/docs/platform_concepts/studio/build/nodes) to ask questions, store values, show information, perform math functions, trigger condition-based actions, and make API calls.                                     |
...
|     Testing the bot  | [Test each flow](https://docs.yellow.ai/docs/platform_concepts/studio/build/Flows/journeys#3-preview-a-flow) as and when you create it to ensure it is working as desired. |
