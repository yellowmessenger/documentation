...
| Send initial user message | Dispatches user messages from the conversation with the bot to the dynamic chat node before the flow control transitions to the dynamic chat node.                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| Send message after chat ends | Forwards messages sent by the user after the conversation concludes with the dynamic chat node to the dynamic chat node.                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
