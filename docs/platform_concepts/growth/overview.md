...
| Section | Description |
| -------- | -------- |
| [Overview](#overview)     | Summary of how your bot is functioning divided into 9 common metrics      |
|[Metrics](https://docs.yellow.ai/docs/platform_concepts/growth/metrics)|Metrics on bot users and API usage of your bot|
|[Visualization](https://docs.yellow.ai/docs/platform_concepts/growth/user-journeys)| Visualise the journeys your users are taking and funnels|
|[Doc cog](https://docs.yellow.ai/docs/platform_concepts/growth/doccog)|Insights generated by the documents uploaded on the Studio section|
