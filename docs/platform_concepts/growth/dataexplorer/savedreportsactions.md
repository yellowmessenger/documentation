...
When you click on **Save query** on the tables page, you can create saved reports that include filters, summarization, and visualization. These saved reports can be scheduled for automatic alerts, added to a dashboard for easy access, or downloaded/deleted as needed. 
