...
For a more efficient approach, we strongly recommend adopting Flow campaigns. Rest assured, bots that were created before August 2023 can still use Notification APIs without any interruptions.
:::
