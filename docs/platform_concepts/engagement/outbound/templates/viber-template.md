...
After creating a Viber template, create a Viber campaign using the template as explained [here](/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign).