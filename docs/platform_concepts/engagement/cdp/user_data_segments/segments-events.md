...
6. You will see the following configuration options.
   ...
   Duration |  <ul><li>today</li><li>yesterday</li><li>last week</li><li>this month</li><li>last month</li><li>on</li><li>after</li></ul> |  This allows you to apply time-based filters to events based on their duration to get a more specific set of users.<br/> For example: <ul><li>Today: Users who signed up (user create event) today.</li><li>Yesterday: Users who purchased products from the brand the previous day.</li><li>Last week: Users who visited your website in the last two weeks.</li><li>This month: Users who signed up to the newsletter in the current month.</li><li>Last month:  Users who renewed subscription in the previous month.</li><li>On [date]: Users who registered for an event on May 15th.</li><li>After [date]: Users who submitted tickets after June 1st. </li></ul>
