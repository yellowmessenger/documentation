...
## 1. WhatsApp chatbot related FAQs

1. **Why WhatsApp chatbot channel?**
...
2. **What can a customer share on WhatsApp chatbot?**
...
3. **In what all ways can a WhatsApp chatbot respond?**
...
4. **What is not possible with WhatsApp chatbot today?**
...
8. **Can we send marketing/promotional notifications on WhatsApp?**

   No. In addition, to send a regular notification as well, the user opt-in consent is a must.

9. **Are buttons allowed within the conversation?**
...
11. **What is the pricing model of WhatsApp?**

   Contact our sales for pricing info.

12. **Can WhatsApp chat bot support multiple languages?**
...
13. **Is there a restriction on WhatsApp for any location or country?**

   WhatsApp chatbot is applicable in all the regions where WhatsApp channel is currently operating.

14. **What are the top use-cases brands can leverage WhatsApp chatbot for?**
...
15. **What is the commerce/business policy of WhatsApp?**
...
## 2. FB Messenger chatbot related FAQs

1. **What can a customer share on FBM chatbot?**
...
2. **In what all ways can a FBM chat-bot respond?**
...
7.  **Can we send marketing/promotional messages on FBM?**
...
9.  **What is the pricing model of FBM chatbot?**

    Contact our sales for pricing info.

10.  **Can FBM chat bot support multiple languages?**

    Yes, the FBM chatbot can support multiple languages.

11.  **How to get onboarded to FBM chatbot and what are the prerequisites?**

    Refer this [document](https://docs.yellow.ai/docs/platform_concepts/channelConfiguration/facebook-messenger/).

12.  **How to make users discover and start using your brand’s chatbot?**
...
13. **What all are the potential use-cases of FBM chatbot?**

    Timely reminders on carts & payments, sales & support, and proactive suggestions are some good usecases.


## 3. Google Business Messaging (GBM) chatbot related FAQs

1. **Why do we need GBM chatbot channel?**
...
2. **What can a customer share on GBM chatbot?**

   - A simple text message
   - An image in JPEG or PNG format

3. **In what all ways can a GBM chatbot respond?**
...
4. **What is not possible with GBM chatbot chatbot today?**
...
5. **Which Industries are allowed to use GBM?**
...
9. **What are the pre-requisites to onboard a Customer?**
...
10. **How much time would it take to deploy a chatbot for a customer in GBM?**
...
11. **Does the brand at any moment have to acknowledge that YM will be handling their Business messages?**

   Yes, [here](https://docs.google.com/document/d/1RWyXmufvlRxkLdMFz3-daCr1h1c9eyN3uUqNBbw2Yuc/edit?usp=sharing) is how.

12. **Can GBM support Multiple languages?**
...
13. **What is the pricing model of GBM?**

   Contact our sales for pricing info.

14. **What all are the discovery points of GBM chatbot channel?**
