...
|----------|-----------------|---------------------|
| [Message nodes](https://docs.yellow.ai/docs/platform_concepts/studio/build/nodes/message-nodes1) | <ul><li>Text</li><li>Image</li><li>Carousel</li><li>Video</li><li>File</li><li>Quick replies</li></ul> | <ul><li>WhatsApp list</li><li>WhatsApp product catalogue</li></ul> |
