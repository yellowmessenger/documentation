...
3. **[Alexa](https://docs.yellow.ai/docs/platform_concepts/channelConfiguration/alexa)** - Leverage Alexa’s voice capability using the NLP trained bots provided by Yellow Messenger and skip the manual hassle.
...
Enable Yellow Messenger chat bots on the World’s largest chat platform and be connected to your customers. To know more about it, click [here](https://docs.yellow.ai/docs/platform_concepts/channelConfiguration/whatsapp-configuration). 
